        ...
        $('[data-notify="container"]').each(function (i, el) {
            ...
            var isSameMsg =
                ...
                $("<div>" + notification.settings.content.message + "</div>")
                    .html()
                    .trim();
            var isSameType = $el.hasClass(
                "alert-" + notification.settings.type,
            );
                        ...
                        switch (cmd) {
                            case "type":
                                ...
                                this.$ele
                                    ...
                                    .removeClass(
                                        "progress-bar-" + self.settings.type,
                                    );
                                ...
                                break;
                            case "icon":
                                var $icon = this.$ele.find(
                                    '[data-notify="icon"]',
                                );
                                if (
                                    self.settings.icon_type.toLowerCase() ===
                                    "class"
                                ) {
                                    $icon
                            ...
                            case "progress":
                                var newDelay =
                                    self.settings.delay -
                                    self.settings.delay * (commands[cmd] / 100);
                            ...
                            case "url":
                                this.$ele
                                    ...
                                    .attr("href", commands[cmd]);
                                break;
                            case "target":
                                this.$ele
                                    .find('[data-notify="url"]')
                                    .attr("target", commands[cmd]);
                                break;
                            default:
                                this.$ele
                                    .find('[data-notify="' + cmd + '"]')
                                    .html(commands[cmd]);
                        }
                    }
                    var posX =
        ...
        bind: function () {
            ...
            if ($.isFunction(self.settings.onClick)) {
                this.$ele.on("click", function (event) {
                    if (
                        event.target !=
                        self.$ele.find('[data-notify="dismiss"]')[0]
                    ) {
