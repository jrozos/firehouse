    ...
    return (function (t) {
        ...
        function (t, n, e) {
            for (
                ...
                if (
                    x &&
                    (x[f] || c(x, f, p), x[l] || c(x, l, m), (s[m] = p), g)
                )
                    ...
                    ("__proto__" in {}
                        ? (function (t, n, r) {
                              try {
                                  (r = e(10)(
                                      Function.call,
                                      e(75).f(Object.prototype, "__proto__")
                                          .set,
                                      2,
                                  ))(t, []),
                    ...
                    return (
                        ...
                        (t.prototype.release = function (t) {
                            ...
                            delete this._activeTouchID,
                                Array.from(t.changedTouches).forEach(
                                    function (t) {
                                        n._delete(t);
                                    },
                                );
                    ...
                    return (
                        ...
                        (t.prototype.update = function (t, n, e) {
                            (this.realSize = Math.min(n / e, 1) * n),
                                ...
                                (this.offset =
                                    (t / e) *
                                    (n + (this.realSize - this.displaySize))),
            ...
            function ut(t) {
                ...
                i(r, "touchstart", function (e) {
                    o.track(e),
                        ...
                        0 === u &&
                            ((n = t.options.damping),
                            (t.options.damping = Math.max(n, 0.5))),
                        u++;
                }),
                    ...
                    return (
                        ...
                        (t.prototype.update = function () {
                            !(function (t) {
                                var n = t.getSize(),
                                    e = {
                                        x: Math.max(
                                            n.content.width - n.container.width,
                                            0,
                                        ),
                                        y: Math.max(
                                            n.content.height -
                        ...
                        (t.prototype.isVisible = function (t) {
                            return (function (t, n) {
                                ...
                                return (
                                    o < Math.min(e.bottom, r.bottom) && i < u
                                );
                            })(this, t);
                        }),
                    ...
                    (n.detachStyle = function () {
                        return (function () {
                            if (dt && "undefined" != typeof window) {
                                ...
                                t &&
                                    t.parentNode &&
                                    (t.parentNode.removeChild(t), (dt = !1));
                            }
                        })();
                    }),
                    (n.version = "8.5.3"),
