...
!(function (t, e) {
    ...
    class Z extends R {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? ($.on(this._element, "pointerdown.bs.swipe", (t) =>
                      this._start(t),
                  ),
                  $.on(this._element, "pointerup.bs.swipe", (t) =>
                      this._end(t),
                  ),
                  this._element.classList.add("pointer-event"))
                : ($.on(this._element, "touchstart.bs.swipe", (t) =>
                      this._start(t),
                  ),
                  $.on(this._element, "touchmove.bs.swipe", (t) =>
                      this._move(t),
                  ),
                  $.on(this._element, "touchend.bs.swipe", (t) =>
                      this._end(t),
                  ));
        }
        ...
        _addEventListeners() {
            this._config.keyboard &&
                ...
                "hover" === this._config.pause &&
                    ($.on(this._element, "mouseenter.bs.carousel", () =>
                        this.pause(),
                    ),
    ...
    class Ut extends R {
        ...
        activate() {
            this._isActive ||
                ...
                $.off(document, Kt),
                $.on(document, "focusin.bs.focustrap", (t) =>
    ...
    class ne extends V {
        ...
        show(t) {
            this._isShown ||
                ...
                $.trigger(this._element, Jt, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
    ...
    const ge = new Set([
        ...
        me = (t, e) => {
            ...
            return e.includes(i)
                ? !ge.has(i) ||
                      Boolean(fe.test(t.nodeValue) || pe.test(t.nodeValue))
    ...
    class Pe extends V {
        ...
        _isAnimated() {
            return (
                ...
                (this.tip && this.tip.classList.contains(Ce))
            );
        }
        _isShown() {
    ...
    class Je extends V {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    $.on(this._element, "keydown.bs.tab", (t) =>
                        this._keydown(t),
                    ));
        }
        static get NAME() {
        ...
        show() {
            ...
            const e = this._getActiveElem(),
                i = e
                    ? $.trigger(e, "hide.bs.tab", { relatedTarget: t })
                    : null;
            $.trigger(t, "show.bs.tab", { relatedTarget: e })
                .defaultPrevented ||
