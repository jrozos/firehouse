    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{Route::current()->getName() === "/dashboard/artists" ? "active" : ""}} " href="{{route('/dashboard/artists')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-users {{Route::current()->getName() === "/dashboard/artists" ? "text-white" : ""}} "></i>
                </div>
                <span class="nav-link-text ms-1">Artistas</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{Route::current()->getName() === "/dashboard/assets" ? "active" : ""}} " href="{{route('/dashboard/assets')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-image {{Route::current()->getName() === "/dashboard/assets" ? "text-white" : ""}}"></i>
                </div>
