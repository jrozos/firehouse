                  ...
                  <div class="row justify-content-center align-items-center text-center g-2 my-5 py-5">
                    <div class="col">
                      ...
                      <ul class="list-group ">
                        ...
                        {{-- <li class="list-group-item border-0">Martes 10:00 - 19:00</li>
                        <li class="list-group-item border-0">Miercoles 10:00 - 19:00</li>
                        <li class="list-group-item border-0">Jueves 10:00 - 19:00</li>
                        <li class="list-group-item border-0">Viernes 10:00 - 19:00</li> --}}
